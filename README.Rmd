...
* The **data/Personal_Dataset.xlsx** file is the dataset that I have been using since mini-data analysis in section A. It is included in this repository because it is used in the testthat-ANOVA.TukeyHSD.R file.
